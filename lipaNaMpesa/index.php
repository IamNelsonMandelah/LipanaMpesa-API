        ...
        <div class="media mt-3 pl-2">
            ...
            <form class="row g-3" action="./stk_initiate.php" method="POST">
                ...
                <div class="col-12">
                  ...
                  <input type="text" id="name" name="jina" placeholder=" Jina lako" required/><br><br>
                  <label for="number">Number</label>
                  <input type="number" id="number" name="phoneNumber" placeholder=" 254721222222"  required/><br><br>
                  <label for="amount">Amount</label>
                  <input type="number" id="amount" name="amount" placeholder=" Amount" required/><br><br>
                  <!-- <label for="email">Email</label>
                  <input type="text" id="email" name="" placeholder="email"  required/><br><br> -->
